...
public class PersonalRecordController {
    ...
    public ResponseEntity<ResponseObject> getAllRecord(@Param("pageIndex")int pageIndex) {
    ...
    public ResponseEntity<ResponseObject> getPersonalRecord(@PathVariable("memberId") int memberId) {
        HttpHeaders headers = new HttpHeaders();
        headers.set("BSM", "PersonalRecord");
